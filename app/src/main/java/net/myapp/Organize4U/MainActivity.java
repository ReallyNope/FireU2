...
import net.myapp.Organize4U.auth.Login;
import net.myapp.Organize4U.auth.Profile;
import net.myapp.Organize4U.auth.Register;
import net.myapp.Organize4U.model.Note;
import net.myapp.Organize4U.note.AddNote;
import net.myapp.Organize4U.note.EditNote;
import net.myapp.Organize4U.note.NoteDetails;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(item.getItemId() == R.id.settings){
            ...
            Toast.makeText(this, "Need to make a account to get more options", Toast.LENGTH_SHORT).show();
        }
